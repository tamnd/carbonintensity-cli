...
```
carbonintensity <command> [arguments] [flags]
```

Run `carbonintensity <command> --help` for the full flag list on any command. This
...
per operation you declare in `carbonintensity/domain.go`.
