...
Most of these come down to network reality or how carbonintensity serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

carbonintensity rate-limits like any public site. carbonintensity already paces
...
Where a surface is gated, carbonintensity reads a cookie or token you supply
...
`carbonintensity`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what carbonintensity actually did
